...
local Window = Rayfield:CreateWindow({
   Name = "NVB Hub | VIP v24.0 FINAL",
   LoadingTitle = "LEFT-SIDE BUTTON EDITION",
...
-- [[ 2. STATIC AIM BUTTON (POJOK KIRI TENGAH) ]]
local ScreenGui = Instance.new("ScreenGui", game.CoreGui)
local AimBtn = Instance.new("TextButton", ScreenGui)
AimBtn.Name = "AimButtonLeftCenter"; AimBtn.Size = UDim2.new(0, 60, 0, 60)
-- POSISI: Pojok Kiri, Vertikal Tengah
AimBtn.Position = UDim2.new(0, 10, 0.45, 0) 
